...
.. image:: https://img.shields.io/pypi/v/RBQ.svg
   :target: https://pypi.python.org/pypi/RBQ
   :alt: PyPI Version
...
RBQ is a fast high-level web crawling and web scraping framework, used to
crawl websites and extract structured data from their pages. It can be used for
a wide range of purposes, from data mining to monitoring and automated testing.

For more information including a list of features check the RBQ homepage at:
http://scrapy.org
